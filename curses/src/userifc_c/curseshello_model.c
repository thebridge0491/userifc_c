...
//void cursessubject_destroy(struct subject *subj) {
//    ;
//}

void* cursessubject_notify(struct subject *subj, void *arg) {
    int buf_len = 64;
...
struct subject* cursessubject_setup(struct subject *subj, void *user_data) {
    ...
    //subj->destroy_func = cursessubject_destroy;
    subj->notify_func = cursessubject_notify;
